...
$GLOBAL['baiviet'][$nametype]['img-width'] = 380;

$GLOBAL['baiviet'][$nametype]['img-height'] = 214;

$GLOBAL['baiviet'][$nametype]['img-ratio'] = 1;

$GLOBAL['baiviet'][$nametype]['icon'] = false;

$GLOBAL['baiviet'][$nametype]['img-width1'] = 78;

$GLOBAL['baiviet'][$nametype]['img-height1'] = 78;

$GLOBAL['baiviet'][$nametype]['banner'] = false;

$GLOBAL['baiviet'][$nametype]['img-width2'] = 1440;

$GLOBAL['baiviet'][$nametype]['img-height2'] = 300;
...
$GLOBAL['baiviet'][$nametype]['img-width'] = 320;
