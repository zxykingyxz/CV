...
$GLOBAL['info'][$nametype]['title_main'] = 'bài viết giới thiệu';

$GLOBAL['info'][$nametype]['title'] = 'Quản lý bài viết giới thiệu';

$GLOBAL['info'][$nametype]['full'] = false;

$GLOBAL['info'][$nametype]['img'] = true;

$GLOBAL['info'][$nametype]['img-width'] = 590;

$GLOBAL['info'][$nametype]['img-height'] = 347;
...
$GLOBAL['info'][$nametype]['links'] = false;

$GLOBAL['info'][$nametype]['photo2'] = false;

$GLOBAL['info'][$nametype]['video'] = false;

$GLOBAL['info'][$nametype]['mota'] = true;

$GLOBAL['info'][$nametype]['mucluc'] = true;
