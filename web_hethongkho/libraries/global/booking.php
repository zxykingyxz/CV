...
// $GLOBAL['booking'][$nametype]['gioitinh'] = false;

// $GLOBAL['booking'][$nametype]['date'] = false;

// $GLOBAL['booking'][$nametype]['time'] = false;
...
// $GLOBAL['booking'][$nametype]['title_main'] = 'Đăng ký số điện thoại tư vấn';

// $GLOBAL['booking'][$nametype]['title'] = 'Quản lý Đăng ký số điện thoại tư vấn';
...
// $GLOBAL['booking'][$nametype]['nhucau'] = false;

// $GLOBAL['booking'][$nametype]['loai_sp'] = false;

// $GLOBAL['booking'][$nametype]['ngaydatlich'] = false;

// $GLOBAL['booking'][$nametype]['khunggio'] = false;
...
// $GLOBAL['booking'][$nametype]['songuoi'] = false;

// $GLOBAL['booking'][$nametype]['noidung'] = true;

// $GLOBAL['booking'][$nametype]['ngaytao'] = false;

// $GLOBAL['booking'][$nametype]['ngayvao'] = false;

// $GLOBAL['booking'][$nametype]['ngayra'] = false;
