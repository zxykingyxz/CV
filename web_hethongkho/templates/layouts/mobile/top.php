        ...
        <div class="row py-2">
            <div class="col basis-full">
                <div class="flex items-center justify-between relative gap-2">
                    ...
                    <div class="">
                        <?= $func->addHrefImg([
                            'classfix' => 'overflow-hidden inline-flex hover-left w-[40px] aspect-[108/90]',
                            'addhref' => true,
                            'href' =>   '',
                            'sizes' => '500x500x2',
                            'isLazy' => true,
                    ...
                    <?php if ($config['layouts']['is_search'] || $config['gg_lang']) { ?>
                        <div class=" flex-1 inline-flex gap-2 items-center content-center  justify-end">
