    ...
    <div class="grid_x wide ">
        <form action="" method="POST" name="form" class="w-full flex flex-wrap gap-4" enctype="multipart/form-data">
            <div class="flex-1  w-full lg:w-auto relative z-10">
                <div class="inline-flex w-full flex-wrap gap-4 max-w-full sticky top-[120px] left-0">
                    ...
                    <div class=" bg-white border border-gray-300 w-full rounded-md shadow-xl shadow-gray-300 overflow-y-hidden overflow-x-auto scroll-x grid grid-cols-1 gap-1 p-2" id="list_product">
            ...
            <div class=" max-w-full basis-full sm:basis-1/2 lg:basis-4/12  min-w-[150px]">
                <div class="sticky top-[120px] left-0">
                    <div class="bg-white rounded-md border border-gray-200 shadow-md p-3 flex flex-wrap flex-col gap-2">
                        ...
                        <div class="form_search_customer w-full  flex flex-wrap gap-2 justify-start items-center relative z-30">
                            <div class="w-full  flex items-center rounded-md bg-white border border-gray-300 overflow-hidden ">
                                <div class="inline-flex justify-center items-center  h-8 aspect-[1/1]">
                                    <i class="fas fa-search font-normal text-base text-gray-500"></i>
                                </div>
                                <input type="text" name="search_customer" class="h-8 border-none bg-inherit pl-1 flex-1 " placeholder="Nhập Tên/Mã Khách Hàng" onkeydown="blockEnter(event)">
                                <div class="close_view_search_customer hidden">
                                    <div class="flex cursor-pointer justify-center items-center w-8 aspect-[1/1]">
                                        <svg xmlns="http://www.w3.org/2000/svg" id="Capa_1" enable-background="new 0 0 320.591 320.591" viewBox="0 0 320.591 320.591" style="width: 15px; height: auto; fill: #ccc;">
                                            <g>
                                                <g id="close_1_">
                                                    <path d="m30.391 318.583c-7.86.457-15.59-2.156-21.56-7.288-11.774-11.844-11.774-30.973 0-42.817l257.812-257.813c12.246-11.459 31.462-10.822 42.921 1.424 10.362 11.074 10.966 28.095 1.414 39.875l-259.331 259.331c-5.893 5.058-13.499 7.666-21.256 7.288z" style="fill: #ccc;" />
                                ...
                                <div class=" view_load_search_customer hidden">
                                    <div class="rp-loader flex justify-center items-center  aspect-[1/1]" style="width: 32px;height: 32px;">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000" style="width: 18px; height: auto; fill: #ccc;">
                                            <circle r="80" cx="500" cy="90" style="fill: #ccc;"></circle>
                                            <circle r="80" cx="500" cy="910" style="fill: #ccc;"></circle>
                                            <circle r="80" cx="90" cy="500" style="fill: #ccc;"></circle>
                            ...
                            <div class="abc absolute top-[calc(100%+5px)] left-0 w-full shadow-md shadow-gray-300 rounded-md z-10 " id="view_customer"></div>
                        </div>
                        <div class="w-full my-1">
                            ...
                            ?>
                            <div class="w-full" id="form_info_customer">
                                <?= $warehouse_func->getTemplateLayoutsFor([
                        ...
                        <div class="flex flex-wrap flex-col gap-2">
                            <?php echo $warehouse_func->getTemplateLayoutsFor([
                                'name_layouts' => 'input_warehouse',
                                'class_form' => 'w-full',
                                'class' => "",
                                'lable' => $warehouse_func->getTitleColumn('heft'),
                                'placeholder' => 'Nhập ' . $warehouse_func->getTitleColumn('heft'),
                                'data' => 'heft',
                                'value' => '',
                                'type' => 'text',
                                'save_cache' => false,
                            ...
                            echo $warehouse_func->getTemplateLayoutsFor([
                                ...
                                'class_form' => 'w-full',
                                'class' => "",
                                'lable' => $warehouse_func->getTitleColumn('size'),
                                'placeholder' => 'Nhập ' . $warehouse_func->getTitleColumn('size'),
                                'data' => 'size',
                                'value' => '',
                                'type' => 'text',
                                'save_cache' => false,
            ...
            <div class=" max-w-full basis-full sm:basis-1/2 lg:basis-3/12  min-w-[150px]">
                <div class="sticky top-[120px] left-0">
                    <div class="bg-white rounded-md border border-gray-200 shadow-md flex flex-wrap flex-col gap-3">
                        <div class="w-full px-3 pt-3 ">
                            ...
                            <div class="form_search_ship w-full  flex flex-wrap gap-2 justify-start items-center relative z-30">
                                <div class="w-full  flex items-center rounded-md bg-white border border-gray-300 overflow-hidden ">
                                    <div class="inline-flex justify-center items-center  h-8 aspect-[1/1]">
                                        <i class="fas fa-search font-normal text-base text-gray-500"></i>
                                    </div>
                                    <input type="text" name="search_ship" class="h-8 border-none bg-inherit pl-1 flex-1 " placeholder="Nhập Tên/Mã Đối Tác" onkeydown="blockEnter(event)">
                                    <div class="close_view_search_ship hidden">
                                        <div class="flex cursor-pointer justify-center items-center w-8 aspect-[1/1]">
                                            <svg xmlns="http://www.w3.org/2000/svg" id="Capa_1" enable-background="new 0 0 320.591 320.591" viewBox="0 0 320.591 320.591" style="width: 15px; height: auto; fill: #ccc;">
                                                <g>
                                                    <g id="close_1_">
                                    ...
                                    <div class=" view_load_search_ship hidden">
                                        <div class="rp-loader flex justify-center items-center  aspect-[1/1]" style="width: 32px;height: 32px;">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000" style="width: 18px; height: auto; fill: #ccc;">
                                                <circle r="80" cx="500" cy="90" style="fill: #ccc;"></circle>
                                                <circle r="80" cx="500" cy="910" style="fill: #ccc;"></circle>
                                ...
                                <div class="abc absolute top-[calc(100%+5px)] left-0 w-full shadow-md shadow-gray-300 rounded-md z-10 " id="view_ship"></div>
                            </div>
                            <div class="w-full mt-2" id="form_info_ship">
                            </div>
                        </div>
                        <div class=" flex flex-wrap justify-items-start items-center gap-2 px-3 border-y border-gray-300 py-3 ">
                            <?php foreach ($list_pay as $key_pay => $value_pay) { ?>
                                <label class="check_pay w-full flex items-center gap-2 cursor-pointer">
                                    <?= $warehouse_func->getTemplateLayoutsFor([
                                        'name_layouts' => 'checkbok_round',
                                        'data' => 'pay',
                                        'value' => $value_pay['value'],
                                        'required' => false,
                                        'checked' => ($key_pay == 0) ? true : false,
                                    ]); ?>
                                    <span>
                                        <?= $value_pay['name'] ?>
                                    </span>
                        ...
                        <div class="grid grid-cols-1 gap-4 px-3 py-3 border-b border-gray-300">
                        ...
                        <div class="flex justify-start items-center gap-2 text-sm sm:text-base px-3 pb-3">
...
<script>
    ...
    $(document).ready(function() {
        ...
        // chọn khu vực
        $('body').on('change', 'select[name="customer[city]"]', function() {
            var value = $(this).val();
            if (value.length > 0) {
                $.ajax({
                    url: 'ajax/warehouse/handleBill.php',
                    type: 'POST',
                    data: {
                        value: value,
                        form: 'city',
                    ...
                    success: function(data) {
                        if ($('body').find("#customer_district").length > 0) {
                            $('body').find("#customer_district").html(data.html.html);
                        }
                    },
                    complete: function() {
                        loadApplication(false);
        ...
        // tìm kiếm khách hàng
        $('body').on('input', 'input[name="search_customer"]', function() {
            var _this = $(this);
            if (_this.closest('.form_search_customer').find('#view_customer').length > 0) {
                clearTimeout(typingTimer);
                _this.closest('.form_search_customer').find('.view_load_search_customer').css('display', 'block');
                _this.closest('.form_search_customer').find('.close_view_search_customer').css('display', 'none');
                typingTimer = setTimeout(function() {
                    ...
                    $.ajax({
                        ...
                        beforeSend: function() {},
                        success: function(data) {
                            _this.closest('.form_search_customer').find('#view_customer').html(data.html.html);
                            _this.closest('.form_search_customer').find('.view_load_search_customer').css('display', 'none');
                            if (value.length > 0) {
                                _this.closest('.form_search_customer').find('.close_view_search_customer').css('display', 'block');
                            } else {
                                _this.closest('.form_search_customer').find('.close_view_search_customer').css('display', 'none');
                            };
                        },
        ...
        $('body').on('click', '.close_view_search_customer', function() {
            var _this = $(this);
            _this.closest('.form_search_customer').find('#view_customer>div').remove();
            _this.closest('.form_search_customer').find('input[name="search_customer"]').val('');
            _this.closest('.form_search_customer').find('.close_view_search_customer').css('display', 'none');
        });
        // chọn customer
        $('body').on('click', '.option_customer', function() {
            let _this = $(this);
            let value = _this.data('value');
            let form_view = _this.closest('.form_search_customer');
            if ($('body').find('#form_info_customer').length > 0) {
                $.ajax({
                    url: 'ajax/warehouse/handleBill.php',
                    type: 'POST',
                    data: {
                        value: value,
                        form: 'option_customer',
                    },
                    dataType: "json",
                    beforeSend: function() {},
                    success: function(data) {
                        form_view.find('.close_view_search_customer').css('display', 'none');
                        form_view.find('input[name="search_customer"]').val('');
                        form_view.find('#view_customer>div').remove();

                        $('body').find('#form_info_customer').html(data.html.html);
                    },
                    complete: function() {}
                });
            }
        });
        // quay lại form tự nhập
        $('body').on('click', '.form_input_customer', function() {
            let _this = $(this);
            if ($('body').find('#form_info_customer').length > 0) {
                $.ajax({
                    url: 'ajax/warehouse/handleBill.php',
        ...
        // tìm kiếm giao hàng
        $('body').on('input', 'input[name="search_ship"]', function() {
            var _this = $(this);
            if (_this.closest('.form_search_ship').find('#view_ship').length > 0) {
                clearTimeout(typingTimer);
                _this.closest('.form_search_ship').find('.view_load_search_ship').css('display', 'block');
                _this.closest('.form_search_ship').find('.close_view_search_ship').css('display', 'none');
                typingTimer = setTimeout(function() {
                    var value = _this.val();
                    $.ajax({
                        url: 'ajax/warehouse/handleBill.php',
                        ...
                        beforeSend: function() {},
                        success: function(data) {
                            _this.closest('.form_search_ship').find('#view_ship').html(data.html.html);
                            _this.closest('.form_search_ship').find('.view_load_search_ship').css('display', 'none');
                            if (value.length > 0) {
                                _this.closest('.form_search_ship').find('.close_view_search_ship').css('display', 'block');
                            } else {
                                _this.closest('.form_search_ship').find('.close_view_search_ship').css('display', 'none');
                            };
                        },
        ...
        $('body').on('click', '.close_view_search_ship', function() {
            var _this = $(this);
            _this.closest('.form_search_ship').find('#view_ship>div').remove();
            _this.closest('.form_search_ship').find('input[name="search_ship"]').val('');
            _this.closest('.form_search_ship').find('.close_view_search_ship').css('display', 'none');
        });
        // chọn ship
        $('body').on('click', '.option_ship', function() {
            let _this = $(this);
            let value = _this.data('value');
            let form_view = _this.closest('.form_search_ship');
            if ($('body').find('#form_info_ship').length > 0) {
                $.ajax({
                    url: 'ajax/warehouse/handleBill.php',
                    type: 'POST',
                    data: {
                    ...
                    beforeSend: function() {},
                    success: function(data) {
                        form_view.find('.close_view_search_ship').css('display', 'none');
                        form_view.find('input[name="search_ship"]').val('');
                        form_view.find('#view_ship>div').remove();
                        $('body').find('#form_info_ship').html(data.html.html);
                        _FRAMEWORK.Lazys();
                    },
                    complete: function() {}
                });
        ...
        // chọn pay
        $('body').on('change', 'input[name="data[pay]"]', function() {
            let _this = $(this);
            if (_this.closest('.check_pay').siblings('.check_pay').length > 0) {
                _this.closest('.check_pay').siblings('.check_pay').find('input[name="data[pay]"]').prop('checked', false);
            }
