...
<body id="body_main" itemscope itemtype="https://schema.org/WebPage" class="bg-gray-100 <?= ($config['layouts']['load_all']) ? 'body_load' : '' ?> ">
    ...
    <div id="wrapper" class="relative ">
        <?php if (($deviceType  == 'computer' || $config['website']['debug-responsive'] == false)) { ?>
            <?php
            include_once _layouts . "pc/top.php";
        ...
        <?php if ($source == 'index') { ?>
            ...
            <section class="section_slider">
                <div class="grid_x wide no_p">
                    <div class="w-full bg-blue-500 text-4xl text-white font-bold flex justify-center items-center text-center aspect-[1220/500]">
                        <span>
        ...
        ?>
        <?php
        $sample->getTemplate(_layouts . "footer/footer_one", [
            'deviceType' => $deviceType,
            'chinhsach' => $chinhsach,
            'hotro' => $hotro,
            'socical' => $socical,
