                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <?php if ($GLOBAL[$com][$type]['dichvu'] == true) { ?>
                                ...
                                <td width="20%" style="text-align: left !important;">Dịch vụ tư vấn</td>
                    ...
                    <tbody>
                        ...
                        <?php for ($i = 0, $count = count($items); $i < $count; $i++) { ?>
                            ...
                            <tr>
                                ...
                                <?php if ($GLOBAL[$com][$type]['dichvu'] == true) {
                                    $getService = $db->rawQueryOne("select id,ten_$lang as ten from #_baiviet where hienthi=1 and type=? and id=? limit 1", array('dich-vu', $items[$i]["id_dichvu"]));
                                ?>
