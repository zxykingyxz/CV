...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.box-search button').click(function(event) {
            ...
            window.location.href = "index.html?com=flashsale&act=man&type=<?= $_GET['type'] ?>&keyword=" +
                        ...
                        success: {
                            ...
                            action: function() {
                                ...
                                redirect(
                                    ...
                                    "index.html?com=flashsale&act=delete&type=<?= $_GET['type'] ?>&page=<?= $_GET['page'] ?>&listid=" +
        ...
        <div class="bc">
            ...
            <ul id="breadcrumbs" class="breadcrumbs">
                ...
                <li>
                    ...
                    <a href="index.html?com=flashsale&act=man<?php if ($_GET['type'] != '') echo '&type=' . $_GET['type']; ?><?php if ($_GET['page'] != '') echo '&page=' . $_GET['page']; ?>"><span>Flash sale</span></a>
        ...
        <div class="oneOne">
            ...
            <div class="box-admin" style="display:flex; align-items:center;">
                ...
                <div class="box-action">
                    ...
                    <a class="btn btn-sm bg-gradient-primary text-white" href="index.html?com=flashsale&act=add<?php if ($_GET['id_product'] != '') echo '&id_product=' . $_GET['id_product']; ?><?php if ($_GET['type'] != '') echo '&type=' . $_GET['type']; ?><?php if ($_GET['page'] != '') echo '&page=' . $_GET['page']; ?>">
                ...
                <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
                    ...
                    <tbody>
                        ...
                        <?php for ($i = 0, $count = count($items); $i < $count; $i++) { ?>
                            ...
                            <tr <?= ($i % 2 == 0) ? 'style="background: rgba(0,0,0,.05);"' : '' ?>>
                                ...
                                <td class="title_name_data">
                                    ...
                                    <?= date("Y-m-d H:i:s", $items[$i]['time_start']) ?>
                                ...
                                <td class="title_name_data">
                                    ...
                                    <?= date("Y-m-d H:i:s", $items[$i]['time_end']) ?>
                                ...
                                <td class="actBtns">
                                    ...
                                    <a class="text-primary" href="index.html?com=flashsale&act=edit<?php if ($_GET['id_product'] != '') echo '&id_product=' . $_GET['id_product']; ?>&id=<?= $items[$i]['id'] ?><?php if ($_GET['type'] != '') echo '&type=' . $_GET['type']; ?><?php if ($_GET['page'] != '') echo '&page=' . $_GET['page']; ?>" title="" class="smallButton tipS" original-title="Sửa"><i class="fas fa-edit"></i></a>



                                    <a class="text-danger" data-product="<?= $items[$i]['id'] ?>" data-com="<?= $_GET['com'] ?>" data-act="delete" data-tbl="<?= $_GET['tbl'] ?>" data-type="<?= $_GET['type'] ?>" data-page="<?= $_GET['page'] ?>" href="javascript:" data-js-delete title="" class="smallButton tipS" original-title="Xóa ">
