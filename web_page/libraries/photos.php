...
class photos
{
    ...
    public function saveMan()
    {
        ...
        $send['tieuchi'] = isset($_POST['tieuchi']) ? 1 : 0;
            ...
            if (!empty($filephu)) {
                ...
                if ($id) {
                    ...
                    if ($filephu['error'] == 0) {
                        ...
                        $photo = $this->_func->uploadImg($id, "photo2", "thumb_" . $k, $filephu, $folder, $this->_com, $table['img-width'], $table['img-height'], $table['img-ratio'], $table['img-b']);
                    ...
                    if ($filephu['error'] == 0) {
                        ...
                        $photo = $this->_func->uploadImg(0, "photo2", "thumb_" . $k, $filephu, $folder, $this->_com, $table['img-width'], $table['img-height'], $table['img-ratio'], $table['img-b']);
        ...
        $send['check_video'] = isset($_POST['check_video']) ? 1 : 0;
