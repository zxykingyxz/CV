...
$GLOBAL['setting']['page_in2'] = false;

$GLOBAL['setting']['page_in'] = false;

$GLOBAL['setting']['page_ne'] = true;

$GLOBAL['setting']['img-width'] = 500;

$GLOBAL['setting']['img-height'] = 500;

$GLOBAL['setting']['page_service'] = false;

$GLOBAL['setting']['page_new'] = false;

$GLOBAL['setting']['page_album'] = false;

$GLOBAL['setting']['page_project'] = false;
...
$GLOBAL['setting']['time_popup'] = false;
