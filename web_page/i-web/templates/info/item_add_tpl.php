...
<form name="supplier" class="form form-validate" action="index.html?com=info&act=save<?php if ($_GET['type'] != '') echo '&type=' . $_GET['type']; ?>" method="post" enctype="multipart/form-data" autocomplete="off" accept-charset="utf-8">

    <div class="control_frm">
        <div class="bc">
            <ul id="breadcrumbs" class="breadcrumbs">
                <li><a href="index.html?com=info&act=capnhat<?php if ($_GET['type'] != '') echo '&type=' . $_GET['type']; ?>"><span><?= $GLOBAL[$com][$type]['title'] ?></span></a>
                </li>
            ...
            <?php foreach ($config['lang'] as $k => $v) { ?>
                ...
                <?php if ($GLOBAL[$com][$type]['slogan']) { ?>
                    <div class="formRow lang_hidden lang_<?= $k ?> <?= ($k == 'vi') ? 'active' : '' ?>">
                        ...
                        <div class="formRight">
                            <input type="text" name="data[slogan_<?= $k ?>]" title="Nhập vị trí" id="slogan_<?= $k ?>" class="tipS validate[required]" value="<?= @$item['slogan_' . $k] ?>" />
                        </div>
                        <div class="clear"></div>
                    </div>
                <?php } ?>
                <?php if ($GLOBAL[$com][$type]['text']) { ?>
                    <div class="formRow lang_hidden lang_<?= $k ?> <?= ($k == 'vi') ? 'active' : '' ?>">
                        <label>Text [<?= $v ?>]</label>
                        <div class="formRight">
                            <input type="text" name="data[text_<?= $k ?>]" title="Nhập vị trí" id="text_<?= $k ?>" class="tipS validate[required]" value="<?= @$item['text_' . $k] ?>" />
                        </div>
                        <div class="clear"></div>
                    </div>
                <?php } ?>

                <?php if ($GLOBAL[$com][$type]['link_type']) { ?>
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <select name="data[link_type]">

                                <option value="">Chọn dạng video</option>

                                <option value="1" <?php if ($item['link_type'] == 1) echo 'selected'; ?>>Dạng upload video</option>

                                <option value="2" <?php if ($item['link_type'] == 2) echo 'selected'; ?>>Dạng link youtube</option>

                                <option value="3" <?php if ($item['link_type'] == 3) echo 'selected'; ?>>Dạng hình ảnh</option>
                ...
                <?php if ($GLOBAL[$com][$type]['mota']) { ?>
                    <div class="formRow lang_hidden lang_<?= $k ?> <?= ($k == 'vi') ? 'active' : '' ?>">
                        <label>Mô tả [<?= $v ?>]</label>
                        <div class="ck_editor">
                            <textarea title="Nhập mô tả . " data-height="400" id="mota_<?= $k ?>" <?= ($GLOBAL[$com][$type]['mota-ckeditor'] == true) ? 'class="ck_editors"' : 'rows="8"' ?> name="data[mota_<?= $k ?>]"><?= @$item['mota_' . $k] ?></textarea>
                        </div>
                        <div class="clear"></div>
                    </div>
                <?php } ?>
                <?php if ($GLOBAL[$com][$type]['noidung']) { ?>
                    <div class="formRow lang_hidden lang_<?= $k ?> <?= ($k == 'vi') ? 'active' : '' ?>">
                        ...
                        <div class="ck_editor">
                            <textarea title="Nhập nội dung . " data-height="400" id="noidung_<?= $k ?>" <?= ($GLOBAL[$com][$type]['noidung-ckeditor'] == true) ? 'class="ck_editors"' : 'rows="8"' ?> name="data[noidung_<?= $k ?>]"><?= @$item['noidung_' . $k] ?></textarea>
                        </div>
                        <div class="clear"></div>
                    </div>
                <?php } ?>
    ...
    <div class="<?= ($GLOBAL[$com][$type]['full'] == true) ? 'oneOne' : 'colRight' ?>">
        <?php if ($GLOBAL[$com][$type]['img'] == true) { ?>
            <div class="widget mtop0">
                <?php if ($GLOBAL[$com][$type]['mucluc'] == true) { ?>
                    <div class="formRow">
                        <div class="formRight">
                            <div class="mt10">
                ...
                <?php if ($GLOBAL[$com][$type]['links'] == true) { ?>
                    <div class="formRow">
                        <label>Links</label>
                        <div class="formRight">
                            <input type="text" name="data[links]" title="Nhập tên link youtube" id="links" class="tipS" value="<?= @$item['links'] ?>" />
                        </div>
                        <div class="clear"></div>
                    </div>
                <?php } ?>
                <div class="formRow">
                    <label><?= ($type == 'ho-so-nang-luc') ? 'Tải file PDF' : 'Tải hình ảnh:' ?></label>
                    <div class="formRight">
                ...
                <?php if ($type == 'ho-so-nang-luc') { ?>
                    <div class="formRow">
                        <label>Tên file hiện tại:</label>
                        <div class="formRight">
            ...
            ?>
                        ...
                        <div class="formRight">
                            <?php foreach ($config['seo-lang'] as $k => $v) { ?>
                                <div class="box-seo lang_hidden lang_<?= $k ?> <?= ($k == 'vi') ? 'active' : '' ?>">
                                    ...
                                    <h3 style="padding-top: 10px;font-size: 20px;line-height: 1.3;color: #1a0dab;margin-bottom: 0px;font-weight:500" class="title_seo" id="title_seo">
                ...
                <div class="widget <?= ($GLOBAL[$com][$type]['img'] == true) ? 'mtop10' : 'mtop0' ?>">
                    ...
                    <?php foreach ($config['seo-lang'] as $k => $v) { ?>
                        ...
                        <div class="formRow lang_hidden lang_<?= $k ?> <?= ($k == 'vi') ? 'active' : '' ?>">
                            <div class="formRight">
                                <input readonly="readonly" type="text" style="width:45px; margin-top:10px; text-align:center;" name="des_char" id="des_char" value="<?= @$item['des_char'] ?>" /> <?= _kytu ?> <b>(Từ 160-300 ký
                                    tự)</b>
                            </div>
                            <div class="clear"></div>
                        </div>
