...
if ($func->isAjax()) {
    ...
    $sql = "select id,type,giaban,giacu,ten_$lang as ten,photo,tenkhongdau_$lang as tenkhongdau from #_baiviet where type in ('dien-tu','dien-lanh','do-gia-dung','hang-trung-bay') $where order by stt asc ";
