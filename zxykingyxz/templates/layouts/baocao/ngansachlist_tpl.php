                ...
                <table class="w-full min-w-[1000px] border-collapse border border-gray-200 shadow-md ">
                    <thead class="">
                        <tr class="<?= $class_title_table_default ?> ">
                            ...
                            <th class="<?= $padding_th_table_default ?> text-left w-[10px] text-nowrap">Ngày Báo Cáo</th>
                            <th class="<?= $padding_th_table_default ?> text-left w-[10px] text-nowrap">Ngày tạo</th>
