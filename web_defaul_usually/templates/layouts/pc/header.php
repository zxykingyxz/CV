...
<header class=" relative  bg-black w-full  z-40   header_menu [&.animate]:shadow-lg  group/header transition-all duration-300 ">
    ...
    <div class="bg-black group-[&.animate]/header:translate-y-0 group-[&.animate]/header:opacity-100 group-[&.animate]/header:visible group-[&.animate]/header:pointer-events-auto pointer-events-none opacity-0 invisible  fixed top-0 left-0 z-40 w-full -translate-y-full transition-all duration-300 ">
        <div class="grid_s wide   ">
            <div class="form_menu relative flex items-center justify-between gap-10">
                ...
                <div class="flex-initial leading-[0]">
                    <?= $func->addHrefImg([
                        'classfix' => 'overflow-hidden inline-flex hover-left w-[230px]  transition-all duration-300',
                        'addhref' => true,
                        'href' =>   '',
                        'sizes' => '330x95x2',
                        'actual_width' => 800,
