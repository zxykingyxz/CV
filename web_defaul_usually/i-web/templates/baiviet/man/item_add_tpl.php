<link href="plugin/sumoselect/sumoselect.min.css" rel="stylesheet" />
        ...
        <div class="mtop0">
            ...
            <div class="<?= ($table['full'] == true) ? 'oneOne' : 'colLeft' ?>">
                ...
                <div class="widget mtop0">
                    ...
                    <?php foreach ($config['lang'] as $k => $v) { ?>
                        ...
                        <?php } ?>
                        <?php if ($table['title_sub'] == true) { ?>

                            <div class="formRow lang_hidden lang_<?= $k ?> <?= ($k == 'vi') ? 'active' : '' ?>">

                                <label>Tiêu đề phụ [<?= $v ?>]</label>

                                <div class="formRight">

                                    <input type="text" data-validation="required" data-validation-error-msg="Không được để trống" name="data[title_sub_<?= $k ?>]" title="Nhập địa chỉ" id="title_sub_<?= $k ?>" class="tipS" value="<?= @$item['title_sub_' . $k] ?>" />
                        ...
                        <?php if ($table['huongdansudung'] == true) { ?>
                            ...
                            <div class="formRow lang_hidden lang_<?= $k ?> <?= ($k == 'vi') ? 'active' : '' ?>">
                                ...
                                <div class="ck_editor">
                                    ...
                                    <textarea data-validation="required" data-validation-error-msg="Không được để trống" title="Nhập nội dung [<?= $v ?>]. " data-height="400" id="huongdansudung_<?= $k ?>" <?= ($table['huongdansudung-ckeditor'] == true) ? 'class="ck_editors"' : 'rows="8"' ?> name="data[huongdansudung_<?= $k ?>]"><?= @$item['huongdansudung_' . $k] ?></textarea>
            ...
            <div class="<?= ($table['full'] == true) ? 'oneOne' : 'colRight' ?>">
                ...
                <div class="widget mtop0">
                    ...
                    <?php } ?>
                    <?php
                    if ($GLOBAL[$com][$type]['segment'] == true) {

                        if (!empty($id)) {
                            $where_ds_product = " and id<>$id ";
                        }
                        $data_product = $db->rawQuery("select id,ten_vi from #_baiviet where type='$type' $where_ds_product and hienthi=1 order by stt asc,id desc", array());
                        $ex_tags = json_decode($item['id_product_list'], true);
                    ?>

                        <div class="formRow">

                            <label>Chọn Sản Phẩm Cùng Phân Khúc</label>

                            <div class="formRight">

                                <select multiple="multiple" name="data[id_product_list][]" class="product_select">

                                    <?php foreach ($data_product as $k => $v) { ?>
                                        <option value="<?= $v['id'] ?>" <?php /* <?=(isset($ex_tags) && count($ex_tags)>0) ? ((in_array($v['id'],$ex_tags)) ? 'selected':''):''?>
                                    */ ?> <?= (in_array($v["id"], explode(",", $item['id_product_list']))) ? 'selected' : '' ?>>
                                            <?= $v['ten_vi'] ?>
                                        </option>
                                    <?php } ?>
                    ...
                    ?>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                ...
                                <select name="data[id_thuonghieu][]" class="thuonghieu">
                    ...
                    <?php if ($table['text_new'] == true) { ?>
                        <div class="formRow">
                            <label>Mẫu Mới</label>
                            <div class="formRight">
                                <input type="text" name="data[text_new]" title="Nhập text_new sản phẩm" id="text_new" class="tipS" value="<?= @$item['text_new'] ?>" />
                            </div>
                            <div class="clear"></div>
                        </div>
                    <?php } ?>
                    <?php if ($table['installment'] == true) { ?>
                        <div class="formRow">
                            <label>Trả Góp <sup>(%)</sup></label>
                            <div class="formRight">
                                <input type="number" min="0" max="999" name="data[installment]" title="Nhập Trả Góp sản phẩm" id="installment" class="tipS" value="<?= @$item['installment'] ?>" />
                            </div>
                            <div class="clear"></div>
                        </div>
                    <?php } ?>
                    ...
                    <?php } ?>
                    <?php if ($table['technology'] == true) { ?>
                        <div class="formRow">
                            <label>Công Nghệ</label>
                            <div class="formRight">
                                <input type="text" name="data[technology]" title="Nhập mã sản phẩm" id="technology" class="tipS" value="<?= @$item['technology'] ?>" />
                            </div>
                            <div class="clear"></div>
                        </div>
                    <?php } ?>
                    <?php if ($table['weight'] == true) { ?>
                        <div class="formRow">
                            <label>Trọng Lượng</label>
                            <div class="formRight">
                                <input type="text" name="data[weight]" title="Nhập mã sản phẩm" id="weight" class="tipS" value="<?= @$item['weight'] ?>" />
                            </div>
                            <div class="clear"></div>
                        </div>
                    <?php } ?>
                    <?php if ($table['size'] == true) { ?>
                        <div class="formRow">
                            <label>Size</label>
                            <div class="formRight">
                                <input type="text" name="data[size]" title="Nhập mã sản phẩm" id="size" class="tipS" value="<?= @$item['size'] ?>" />
                            </div>
                            <div class="clear"></div>
                        </div>
                    <?php } ?>
                    <?php if ($table['capacity'] == true) { ?>
                        <div class="formRow">
                            <label>Dung Tích</label>
                            <div class="formRight">
                                <input type="text" name="data[capacity]" title="Nhập mã sản phẩm" id="capacity" class="tipS" value="<?= @$item['capacity'] ?>" />
                            </div>
                            <div class="clear"></div>
                        </div>
                    <?php } ?>
                    <?php if ($table['power'] == true) { ?>
                        <div class="formRow">
                            <label>Công suất</label>
                            <div class="formRight">
                                <input type="text" name="data[power]" title="Nhập mã sản phẩm" id="power" class="tipS" value="<?= @$item['power'] ?>" />
                            </div>
                            <div class="clear"></div>
                        </div>
                    <?php } ?>
                    <?php if ($table['door'] == true) { ?>
                        <div class="formRow">
                            <label>Cửa</label>
                            <div class="formRight">
                                <input type="text" name="data[door]" title="Nhập mã sản phẩm" id="door" class="tipS" value="<?= @$item['door'] ?>" />
                            </div>
                            <div class="clear"></div>
                        </div>
                    <?php } ?>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                ...
                                <select name="data[id_loai]" id="id_loai" class="main_select">
                                    ...
                                    <option value="2" <?= (@$item['id_loai'] == 2) ? 'selected' : '' ?>>Đã hết hàng
                        ...
                        <?php if ($_GET['act'] == 'edit' || $_GET['act'] == 'copy') { ?>
                            ...
                            <div class="formRow">
                                ...
                                <div class="formRight">
                                    ...
                                    <div class="mt10"><img style="max-width:clamp(100px,100%,300px); height: auto;" src="<?= _upload_baiviet . $item['photo2'] ?>" alt="NO PHOTO" width="<?= $table['img-width'] ?>" height="<?= $table['img-height'] ?>" /></div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        window.asd = $('.product_select').SumoSelect({
            search: true,
            searchText: 'Enter here product.',
            placeholder: 'Chọn Sản Phẩm',
        });
        window.asd = $('.thuonghieu').SumoSelect({
            okCancelInMulti: false,
            selectAll: false,
            locale: (['Áp dụng', 'Hủy', 'Chọn Tất cả', 'Xóa Tất Cả']),
            search: true,
            searchText: 'Enter here brand.',
