        ...
        return this.each(function() {
            ...
            if (settings.event_hover === true) {
                $form.on("mouseenter", "." + settings.button, function() {
                    btnNoneBlock($(this), "." + settings.button, $(this).closest($form));
                });
                if (settings.close) {
