...
?>
    <div class="group/templateImages_One load_website  overflow-hidden rounded-full transition-all duration-300   <?= $class ?> ">
        <div class='relative rounded overflow-hidden'>
            ...
            <div class="pointer-events-none absolute top-0 left-0 w-full h-full flex justify-center items-center group-hover/templateImages_One:scale-110 group-hover/templateImages_One:opacity-0 transition-all duration-300" style="background: linear-gradient(360deg, #000 0%, rgba(255, 255, 255, 0.00) 100%);">
