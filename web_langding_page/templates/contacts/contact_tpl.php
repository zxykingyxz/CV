                                    ...
                                    <div class=" flex-1 flex flex-wrap flex-col gap-3">
                                        ...
                                        <div class="w-full">
                                            <div class="flex items-center justify-between gap-2 ">
                                                ...
                                                <div class="form_captcha_contact flex items-center result-code">
                                                    <div class="code_captcha_contact text-center w-[70px]"></div>
                                                    <div class="btn_captcha_contact cursor-pointer [&.on]:animate-load-captcha-reverse transition-all duration-50 w-[36px] aspect-[1/1] flex justify-center items-center"><i class="fa-solid fa-arrows-rotate"></i></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
