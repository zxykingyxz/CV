...
$content = "text-xs sm:text-sm leading-[1.78] sm:leading-[1.78] h-[calc(12px*1.78*3)] sm:h-[calc(14px*1.78*3)]  font-normal font-main-400 text-[#3D3A3A] ";
...
?>
    <div class="group/templateNew_two load_website ">
        <div class=" w-full aspect-[387/305] overflow-hidden rounded mb-5 relative leading-[0]">
            <?= $func->addHrefImg([
                'classfix' => 'w-full',
                'addhref' => true,
