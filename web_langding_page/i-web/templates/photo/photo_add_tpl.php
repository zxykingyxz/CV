...
<?php
?>
<form name="supplier" class="form form-validate" action="index.html?com=photo&act=save<?php if ($_GET['id'] != '') echo '&id=' . $_GET['id']; ?><?php if ($_GET['type'] != '') echo '&type=' . $_GET['type']; ?><?php if ($_GET['page'] != '') echo '&page=' . $_GET['page']; ?>" method="post" enctype="multipart/form-data" autocomplete="off" accept-charset="utf-8">
    <div class="mtop0">
        <div class="oneOne">
        ...
        <div class="oneOne">
            <div class="widget mtop0">
                        ...
                        <div class="formRow lang_hidden lang_<?= $k ?>  <?= ($k == 'vi') ? 'active' : '' ?>">
                            ...
                            <div class="formRight">
                                ...
                                <?php } else { ?>
                                    ...
                                    <input <?php if (isset($_GET['com']) && $_GET['com'] == 'trademark') { ?>data-validation="required" data-validation-allowing="jpg, png" data-validation-max-size="300kb" data-validation-error-msg-required="Bạn chưa chọn file" <?php } ?> type="file" id="file_<?= $k ?>" name="file_<?= $k ?>" />
                ...
                <?php } ?>
                <?php if ($GLOBAL[$com][$type]['link_facebook'] == true) { ?>
                    <div class="formRow">
                        <label>Link Facebook:</label>
                        <div class="formRight">
                            <input type="text" id="code_pro" name="data[link_facebook]" title="Nhập link liên kết cho hình ảnh" class="tipS" value="<?= @$item['link_facebook'] ?>" />
                        </div>
                        <div class="clear"></div>
                    </div>
                <?php } ?>
                <?php if ($GLOBAL[$com][$type]['link_twitter'] == true) { ?>
                    <div class="formRow">
                        <label>Link Twitter:</label>
                        <div class="formRight">
                            <input type="text" id="code_pro" name="data[link_twitter]" title="Nhập link liên kết cho hình ảnh" class="tipS" value="<?= @$item['link_twitter'] ?>" />
                        </div>
                        <div class="clear"></div>
                    </div>
                <?php } ?>
                <?php if ($GLOBAL[$com][$type]['link_tiktok'] == true) { ?>
                    <div class="formRow">
                        <label>Link TikTok:</label>
                        <div class="formRight">
                            <input type="text" id="code_pro" name="data[link_tiktok]" title="Nhập link liên kết cho hình ảnh" class="tipS" value="<?= @$item['link_tiktok'] ?>" />
                        </div>
                        <div class="clear"></div>
                    </div>
                <?php } ?>
