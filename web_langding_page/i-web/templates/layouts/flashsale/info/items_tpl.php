        ...
        <div class="oneOne">
            ...
            <div class="widget mtop0">
                ...
                <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
                    ...
                    <tbody>
                        <?php
                        $pro_sale = $db->rawQuery("select stt, id,ten_$lang as ten,photo,giaban from #_baiviet where type in ('san-pham','dien-tu','dien-lanh','do-gia-dung','hang-trung-bay') and flashsale=1", array());
