    ...
    $.fn.animationNumber = function(options) {
        ...
        return this.each(function() {
            ...
            function startCounting() {
                const end = parseFloat($this.data("value") || 0);
                ...
                function step(timestamp) {
                    ...
                    let interimNumber = Math.abs(easedProgress * (end - settings.start) + settings.start);
...
// Ví dụ sử dụng
// $("[data-module='countup']").animationNumber({ duration: 3000, type: 'percent' });
