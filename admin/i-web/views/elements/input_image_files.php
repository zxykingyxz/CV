<div class="w-full">
    ...
    <div class="relative flex items-center justify-center border rounded-md cursor-pointer bg-slate-100 dropzone border-slate-200 dark:bg-zink-600 dark:border-zink-500 mt-2">
        <div class="fallback">
            <input type="file" accept="image/*" multiple="multiple" class="cursor-pointer absolute top-0 left-0 z-10 opacity-0 w-full h-full">
        </div>
