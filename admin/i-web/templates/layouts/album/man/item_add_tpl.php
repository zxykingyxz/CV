<?php if ($GLOBAL[$_COM][$_TYPE]['seo'] == true) { ?><script>
...
<div class="wrapper">
    ...
    <div class="control_frm">
        <div class="bc">
            <ul id="breadcrumbs" class="breadcrumbs">
                <li><a
                        href="index.php?com=album&act=add<?php if ($_REQUEST['type'] != '') echo '&type=' . $_REQUEST['type']; ?>"><span><?= $GLOBAL[$_COM][$_TYPE]['title'] ?></span></a>
                </li>
    ...
    <form name="supplier" id="validate" class="form"
        ...
        <div class="mtop0">
            ...
            <div class="<?= ($GLOBAL[$_COM][$_TYPE]['full'] == true) ? 'oneOne' : 'colLeft' ?>">
                <div class="widget mtop0">
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                ...
                                <span style="display: inline-block; line-height: 30px;color:#CCC;">
                                    Width: <?= $GLOBAL[$_COM][$_TYPE]['img-width'] * $GLOBAL[$_COM][$_TYPE]['img-ratio'] ?>px -
                                    <?= $GLOBAL[$_COM][$_TYPE]['img-height'] * $GLOBAL[$_COM][$_TYPE]['img-ratio'] ?>px
                                </span>
                            </div>
                            <div class="clear"></div>
                        </div>
                    ...
                    <?php foreach ($config['lang'] as $k => $v) { ?>
                        ...
                        <?php if ($GLOBAL[$_COM][$_TYPE]['mota'] == true) { ?>
                            <div class="formRow lang_hidden lang_<?= $k ?> <?= ($k == 'vi') ? 'active' : '' ?>">
                                <label>Mô tả [<?= $v ?>]</label>
                                <div class="ck_editor">
                        ...
                        <?php } ?>
                        <?php if ($GLOBAL[$_COM][$_TYPE]['noidung'] == true) { ?>
                            <div class="formRow lang_hidden lang_<?= $k ?> <?= ($k == 'vi') ? 'active' : '' ?>">
            ...
            <div class="<?= ($GLOBAL[$_COM][$_TYPE]['full'] == true) ? 'oneOne' : 'colRight' ?>">
                <div class="widget mtop0">
                    <div class="title"><img src="./images/icons/dark/record.png" alt="" class="titleIcon" />
                        <h6>Hình ảnh</h6>
                    </div>

                    <?php if ($GLOBAL[$_COM][$_TYPE]['img-gallery'] == true) { ?>
                        <div class="formRow">
                ...
                <?php if ($GLOBAL[$_COM][$_TYPE]['seo'] == true) { ?>
