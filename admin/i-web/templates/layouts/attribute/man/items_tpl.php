        ...
        <div class="bc">
            ...
            <ul id="breadcrumbs" class="breadcrumbs">
                ...
                <li><a
                        ...
                        href="index.html?com=attribute&act=man<?php if ($_GET['id_list'] != '') echo '&id_list=' . $_GET['id_list']; ?><?php if ($_GET['id_cat'] != '') echo '&id_cat=' . $_GET['id_cat']; ?><?php if ($_GET['id_item'] != '') echo '&id_item=' . $_GET['id_item']; ?><?php if ($_GET['id_sub'] != '') echo '&id_sub=' . $_GET['id_sub']; ?><?php if ($_GET['type'] != '') echo '&type=' . $_GET['type']; ?><?php if ($_GET['page'] != '') echo '&page=' . $_GET['page']; ?>"><span><?= $GLOBAL[$_COM][$_TYPE]['title'] ?></span></a>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <?php if ($GLOBAL[$_COM][$_TYPE]['img'] == true) { ?>
                                ...
                                <?php foreach ($GLOBAL[$_COM][$_TYPE]['status'] as $key => $value) { ?>

                                    <td style="width: 60px; text-align: center;"><?= $value ?></td>

                                <?php } ?>

                                <?php foreach ($GLOBAL[$_COM][$_TYPE]['check'] as $key => $value) { ?>
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <?php if (!empty($GLOBAL[$_COM][$_TYPE]['status'])) {
                                        $arr_status = explode(',', $items[$i]['status']); ?>

                                        <?php foreach ($GLOBAL[$_COM][$_TYPE]['status'] as $k1 => $v1) { ?>

                                            <td class="sortCol" align="center">

                                                <label class="stardust-checkbox checkOnOff">

                                                    <input class="checker-status" data-table="<?= $_COM ?>" data-type="<?= $_TYPE ?>" data-id="<?= $items[$i]['id'] ?>"
                ...
                buttons: {
                    ...
                    success: {
                        ...
                        action: function() {
                            ...
                            updateSelect(_v, _idp, '<?= $_TYPE ?>', 'idl');
                ...
                buttons: {
                    ...
                    success: {
                        ...
                        action: function() {
                            ...
                            updateSelect(_v, _idp, '<?= $_TYPE ?>', 'idc');
                ...
                buttons: {
                    ...
                    success: {
                        ...
                        action: function() {
                            ...
                            updateSelect(_v, _idp, '<?= $_TYPE ?>', 'idi');
