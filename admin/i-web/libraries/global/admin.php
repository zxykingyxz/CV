...
$GLOBAL['baiviet'][$nametype]['contents'] = array(
    [
        "title" => "Mô Tả",
        "type" => "mota",
        "ckeditor" => true,
...
// $GLOBAL['map'][$nametype]['color'] = false;
...
$GLOBAL['company'][$nametype]['title_main'] = 'Thời gian làm việc';

$GLOBAL['company'][$nametype]['title'] = 'Quản lý Thời gian làm việc';
...
$GLOBAL['photo'][$nametype]['img-height'] = 500;
...
$nametype = 'slider-mobile';

$GLOBAL['photo'][$nametype]['title_main'] = 'Slider Mobile';

$GLOBAL['photo'][$nametype]['title'] = 'Quản lý slider Moibile';
...
$GLOBAL['photo'][$nametype]['title'] = 'Quản lý Mạng xã hội';
...
$GLOBAL['photo'][$nametype]['title_main'] = 'Tool';

$GLOBAL['photo'][$nametype]['title'] = 'Quản lý Tool';
...
// $GLOBAL['photo'][$nametype]['title_main'] = 'video';

// $GLOBAL['photo'][$nametype]['title'] = 'Quản lý video';
...
// $GLOBAL['photo'][$nametype]['photo2'] = false;

// $GLOBAL['photo'][$nametype]['img-width'] = 285;

// $GLOBAL['photo'][$nametype]['img-height'] = 190;
...
// $GLOBAL['photo'][$nametype]['rating'] = false;
...
$GLOBAL['photo'][$nametype]['title_main'] = 'Hình ảnh';

$GLOBAL['photo'][$nametype]['title'] = 'Quản lý Hình ảnh';

$GLOBAL['photo'][$nametype]['full'] = false;

$GLOBAL['photo'][$nametype]['img'] = true;

$GLOBAL['photo'][$nametype]['img-width'] = 620;

$GLOBAL['photo'][$nametype]['img-height'] = 620;
